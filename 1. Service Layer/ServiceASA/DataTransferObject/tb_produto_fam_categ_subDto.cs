...
{
    [DataContract(Name = "tb_produto_fam_categ_sub")]
    public partial class tb_produto_fam_categ_subDto
    {
        ...
        [DataMember]
        public virtual Int32 scat_id { get; set; }
        [DataMember]
        public virtual String scat_descricao { get; set; }
        [DataMember]
        public virtual String scat_situacao { get; set; }
        [DataMember]
        public virtual Nullable<DateTime> scat_dt_cadastro { get; set; }
        [DataMember]
        public virtual Nullable<DateTime> scat_dt_alteracao { get; set; }
        ...
        //}
        [DataMember]
        public virtual tb_produto_fam_categoriaDto tb_produto_fam_categoria { get; set; }
