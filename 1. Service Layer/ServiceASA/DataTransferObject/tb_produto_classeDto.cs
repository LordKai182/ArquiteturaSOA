...
{
    [DataContract(Name = "tb_produto_classe")]
    public partial class tb_produto_classeDto
    {
        #region Primitive Properties
        [DataMember]
        public virtual Int32 cla_id { get; set; }
        [DataMember]
        public virtual String cla_descricao { get; set; }
        [DataMember]
        public virtual String cla_situacao { get; set; }
        [DataMember]
        public virtual Nullable<DateTime> cla_dt_cadastro { get; set; }
        [DataMember]
        public virtual Nullable<DateTime> cla_dt_alteracao { get; set; }
