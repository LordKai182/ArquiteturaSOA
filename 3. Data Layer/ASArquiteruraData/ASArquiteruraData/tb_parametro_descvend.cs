...
public partial class tb_parametro_descvend
{
    ...
    public Nullable<bool> par_aplicar { get; set; }
    ...
    public Nullable<decimal> par_margem_ate_1 { get; set; }

    public Nullable<decimal> par_percentual_1 { get; set; }

    public Nullable<decimal> par_margem_ate_2 { get; set; }

    public Nullable<decimal> par_percentual_2 { get; set; }

    public Nullable<decimal> par_margem_ate_3 { get; set; }

    public Nullable<decimal> par_percentual_3 { get; set; }

    public Nullable<decimal> par_margem_ate_4 { get; set; }

    public Nullable<decimal> par_percentual_4 { get; set; }

    public Nullable<decimal> par_margem_ate_5 { get; set; }
