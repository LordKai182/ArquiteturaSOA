...
public partial class tb_parametro_comissao
{
    ...
    public Nullable<decimal> par_desconto_ate_1 { get; set; }

    public Nullable<decimal> par_percentual_1 { get; set; }

    public Nullable<decimal> par_desconto_ate_2 { get; set; }

    public Nullable<decimal> par_percentual_2 { get; set; }

    public Nullable<decimal> par_desconto_ate_3 { get; set; }

    public Nullable<decimal> par_percentual_3 { get; set; }

    public Nullable<decimal> par_desconto_ate_4 { get; set; }

    public Nullable<decimal> par_percentual_4 { get; set; }

    public Nullable<decimal> par_desconto_ate_5 { get; set; }
