...
public partial class tb_produto_classe
{
    ...
    public string cla_situacao { get; set; }

    public Nullable<System.DateTime> cla_dt_cadastro { get; set; }

    public Nullable<System.DateTime> cla_dt_alteracao { get; set; }
